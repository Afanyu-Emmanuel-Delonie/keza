  ...
  Widget build(BuildContext context) {
    return Consumer<TripsProvider>(
      builder: (context, provider, _) {
        final itemId = 'dest_${(destination['name'] as String).replaceAll(' ', '_').toLowerCase()}';
        final isLiked = provider.isFavourite(itemId);
        ...
        final item = TripItem(
          ...
          price: destination['price'] as String? ?? 'Free',
          rating: destination['rating'] as String? ?? '4.5',
        );
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: isLiked ? AppColors.errorSoft : Colors.white.withOpacity(0.25),
