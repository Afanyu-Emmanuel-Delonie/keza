...
abstract class TripsRepository {
  ...
  List<TripGroup> get myGroups;when we notify user that we will notify them when trip is ready then lets return back to ai page but make sure bottom na is showing
